<div id="affwp-affiliate-dashboard-referrals" class="affwp-tab-content">
	...
	<table id="affwp-affiliate-dashboard-referrals" class="affwp-table" style="width:100%">
		<thead>
			<tr>
				<th class="referral-id">ID#</th>
		...
		<tbody>
			<?php if ( $referrals ) : ?>
				...
				<?php foreach ( $referrals as $referral ) : ?>
					<tr>
						<td class="referral-id">#<?=$referral->reference?></td>
						...
						<td class="referral-date"><?=date_i18n( 'Y-m-d', strtotime( $referral->date ) ); ?></td>
